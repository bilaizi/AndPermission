...
class ImplPermission implements Permission {
    ...
    private Rationale rationale = new Rationale() {
        @Override
        public void cancel() {
            invokeOnRequestPermissionsResult(
                    object, requestCode, permissions,
                    PermissionUtils.getPermissionsResults(object, permissions)
            );
        }
    ...
    private static void invokeOnRequestPermissionsResult(Object o, int requestCode,
